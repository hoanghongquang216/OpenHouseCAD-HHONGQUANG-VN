...
static void TestVector2CompoundAssignment() {
    Vector2i v{1, 1};
    v += Vector2i{2, 2};
    OH_CHECK((v == Vector2i{3, 3}));
    v -= Vector2i{1, 1};
    OH_CHECK((v == Vector2i{2, 2}));
    v *= 2;
    OH_CHECK((v == Vector2i{4, 4}));
}

static void TestPoint2CompoundAssignment() {
    Point2i pt{1, 1};
    pt += Vector2i{4, 4};
    OH_CHECK((pt == Point2i{5, 5}));
    pt -= Vector2i{2, 2};
    OH_CHECK((pt == Point2i{3, 3}));
}
